...
DAG_ID = 'amundsem_databuilder_postgres'
...
POSTGRES_HOST = 'amundsen-postgres-1'
POSTGRES_DB = 'airflow'
POSTGRES_PORT = 5432

SUPPORTED_SCHEMAS = ['public']
SUPPORTED_SCHEMAS_SQL_IN_CLAUSE = "('{schemas}')".format(schemas="', '".join(SUPPORTED_SCHEMAS))
...
def create_table_extract_job():
    where_clause_suffix = f'st.schemaname in {SUPPORTED_SCHEMAS_SQL_IN_CLAUSE}'
